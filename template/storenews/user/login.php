...
<div class="fui-navbar" style="max-width: 550px;z-index: 100;">
        <a href="../" class="nav-item  "> <img src="../assets/user/img/home.png" class="img1"> <span class="label" style="color:#999;line-height: unset;font-weight: inherit;">首页</span> </a>
        <a href="../?mod=type" class="nav-item active"> <img src="../template/storenews/img/fl.png" class="img1"> <span class="label" style="color:#999;line-height: unset;font-weight: inherit;">分类</span> </a>
        <a href="../?mod=query" class="nav-item active"> <img src="../assets/user/img/tab_order.png" class="img1"> <span class="label" style="color:#999;line-height: unset;font-weight: inherit;">订单</span> </a>
        ...
        <a href="./" class="nav-item active"> <img src="../assets/user/img/tab_my_active.png" class="img1">  <span class="label" style="color:#1492fb;line-height: unset;font-weight: inherit;">会员中心</span> </a>
    </div>
