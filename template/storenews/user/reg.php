...
.fui-page-group-bg{
     background-image: url('../template/storenews/tupian/bg4.7f041b07.png');
        ...
        <form id="form1">
            <div class="fui-modal popup-modal in">
                <div class="account-layer login" style="margin-top:1rem">
                    <div class="account-layer-title" style="margin-top:38px;"><?php echo $conf['sitename']; ?></div>
                        <div class="account-main">
                            <div class="account-back"><i class="icon icon-back"></i></div>
                           <div class="account-title">
                               <font class="account-title-l">用户注册</font>
...
<div class="fui-navbar" style="max-width: 550px;z-index: 100;">
        <a href="../" class="nav-item  "> <img src="../assets/user/img/home.png" style="24px;width: 24px;"> <span class="label" style="color:#999;line-height: unset;font-weight: inherit;">首页</span> </a>
        <a href="../?mod=type" class="nav-item active"> <img src="../template/storenews/img/fl.png"style="24px;width: 24px;"> <span class="label" style="color:#999;line-height: unset;font-weight: inherit;">分类</span> </a>
        <a href="../?mod=query" class="nav-item active"> <img src="../assets/user/img/tab_order.png"style="24px;width: 24px;"> <span class="label" style="color:#999;line-height: unset;font-weight: inherit;">订单</span> </a>
            <a href="../?mod=kf" class="nav-item "> <img src="<?php echo $cdnserver?>template/storenews/img/tab_kefu.png" class="img1"><span class="label" >客服</span> </a>
        <a href="./" class="nav-item active"> <img src="../assets/user/img/tab_my_active.png"style="24px;width: 24px;">  <span class="label" style="color:#1492fb;line-height: unset;font-weight: inherit;">会员中心</span> </a>
    </div>
</div>
