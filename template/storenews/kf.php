...
<div id="body">
  ...
  .img1{
   ...
   <div class="fui-navbar" style="max-width: 550px;z-index: 100;">
            <a href="./" class="nav-item "> <img src="<?php echo $cdnserver?>template/storenews/img/home.png" class="img1"><span class="label">首页</span>
            </a>
           <a href="./?mod=type" class="nav-item"> <img src="<?php echo $cdnserver?>template/storenews/img/fl.png" class="img1"><span class="label">分类</span>
            </a>
            <a href="./?mod=query" class="nav-item ">  <img src="<?php echo $cdnserver?>assets/user/img/tab_order.png" class="img1"><span class="label">订单</span> </a>
            <a href="./?mod=kf" class="nav-item active"> <img src="<?php echo $cdnserver?>template/storenews/img/tab_kf.png" class="img1"><span class="label">客服</span> </a>
            <a href="./user/" class="nav-item "> <img src="<?php echo $cdnserver?>template/storenews/img/tab_my.png" class="img1"><span class="label">会员中心</span> </a>
        </div>
