...
<div class="form-group">
	<div class="input-group">
		...
		<input type="text" name="kmsn" value="" class="form-control" id="kmsn" name="kmsn" placeholder="数量"></input>
	</div>
</div>
<div class="form-group">
	<div class="input-group">
...
if($tid==NULL or $kms==NULL){
	...
	for( $i=0;$i<(int)$kmsn;$i++){
		if(empty($split)){
			$km_arr=explode(' ',$match[0]);
		}else{
			$km_arr=explode($split,$match[0]);
		}
