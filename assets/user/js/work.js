...
function  openmsg1() {
    layer.open({
        ...
        content: '<center><div class="showtip display-column  align-center" style="background:#FFF">'+
            ...
            '<font style="color: #999999">凡升级成为本站站长，且手里有靠谱项目需要推广的，均可在本页面提交投稿申请。</font><br>'+
            '</div>'+
            ...
            '<font style="color: #999999">所有分站都将显示你的项目，几万人帮你推广，收益直接到余额，秒提现！</font><br>'+
            '</div>'+
            '<div class="text-left" style="width:100%;padding: 15px">'+
            '<font style="font-weight: 800;line-height: 3rem">三、审核机制</font><br>'+
            '<font style="color: #999999">1、高级站长投稿优先审核。<br>2、项目介绍及文案课程齐全优先审核。<br>3、项目内容合法合规的优先审核。</font><br>'+
            '</div>'+
            '<div class="text-left" style="width:100%;padding: 15px;background:#f2f2f2 ">'+
            '<font style="font-weight: 800;line-height: 3rem">四、收益模式</font><br>'+
            '<font style="color: #999999">项目投稿一经平台采纳，则按本平台订单一单一结，每笔订单享受0.5-2元的投稿分成。</font><br>'+
            '</div>'+
            '<div class="text-left" style="width:100%;padding: 15px">'+
            '<font style="font-weight: 800;line-height: 3rem">五、结算机制</font><br>'+
            '<font style="color: #999999">支持微信/支付宝收款结算。</font><br>'+
            '</div>'+
