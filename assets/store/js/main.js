...
function getPoint() {
	...
	if(inputname=='hide'){
		...
		$('#inputsname').append('<div class="form-group form-group-transparent form-group-border-bottom"><div class="input-group" style="width:100%"><label class="input-group-addon"  id="inputname">'+inputname+'：</label><div class="layui-input-"><input type="text" name="inputvalue" id="inputvalue" value="'+($_GET['qq']?$_GET['qq']:'')+'" class="form-control" required onblur="checkInput()"/></div></div></div>');
	}
	...
	if(inputsname!=''){
		$.each(inputsname.split('|'), function(i, value) {
			...
			if(value.indexOf('{')>0 && value.indexOf('}')>0){
				...
				$('#inputsname').append('<div class="input-group" style="width:100%"><label class="input-group-addon" id="inputname'+(i+2)+'">'+selectname+'：</label><div class="layui-input-"><select name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" class="form-control">'+addstr+'</select></div></div>');
			...
			if(value=='说说ID'||value=='说说ＩＤ'||inputsnametype=='ssid')
				...
				var addstr='';
			if(addstr!=''){
				$('#inputsname').append('<div class="form-group form-group-transparent form-group-border-bottom"><div class="input-group" style="width:100%"><label class="input-group-addon"  id="inputname'+(i+2)+'" gettype="'+inputsnametype+'">'+value+'：</label><div class="layui-input-" style="padding-right: 80px !important;"><input type="text" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" class="form-control" required/></div>'+addstr+'</div></div>');
			}else{
				$('#inputsname').append('<div class="form-group form-group-transparent form-group-border-bottom"><div class="input-group" style="width:100%"><label class="input-group-addon"  id="inputname'+(i+2)+'" gettype="'+inputsnametype+'">'+value+'：</label><div class="layui-input-"><input type="text" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" class="form-control" required/></div></div></div>');
			}
			}
		});
	}
